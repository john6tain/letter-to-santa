	...
	return (
		<nav className="bg-white border-gray-200 dark:bg-gray-900">
			<div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
				...
				<div className={`flex items-center md:order-2 space-x-1 md:space-x-2 rtl:space-x-reverse mt-4 md:mt-0`}>
					<a href="https://www.noradsanta.org/" target="_blank"> <Image src="/sleigh.png" className="sleigh"
																																				alt="sleigh"
																																				width="100" height="100"/></a>

					<a href="#"
						 className={`hidden md:block text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800`}
