...
export default function Card({title, description, link, username, handleChange, addNewCard, removeCard, onClick}: CardProps) {
    ...
    return (
        <a href="#"
           className="relative mr-2 ml-2 mt-2 mb-2 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" onClick={onClick}>
